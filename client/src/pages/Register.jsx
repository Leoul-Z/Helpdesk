          ...
          <div className="w-full max-w-md bg-surface-container-lowest rounded-xl shadow-xl p-space-xl relative z-10">
            <div className="flex flex-col items-center text-center mb-space-xl">
              <div className="w-16 h-16 rounded-2xl bg-primary-container flex items-center justify-center mb-space-md shadow-sm">
                <span className="material-symbols-outlined text-on-primary-container text-[32px]">person_add</span>
              </div>
              <h1 className="text-headline-lg font-headline-lg text-on-surface tracking-tight mb-space-xs">Create an Account</h1>
              <p className="text-body-md text-on-surface-variant">Sign up to submit IT &amp; Facilities tickets</p>
            </div>
            
            <form className="flex flex-col gap-space-lg" onSubmit={handleRegister}>
              {error && <div className="text-error text-center text-sm font-medium">{error}</div>}
              
              <div className="flex flex-col gap-space-xs">
                <label className="text-label-md text-on-surface font-medium" htmlFor="name">Full Name</label>
              ...
              <div className="flex items-center justify-center text-body-md mt-2">
                <span className="text-on-surface-variant mr-1">Already have an account?</span>
                <a className="text-primary font-medium hover:underline cursor-pointer" onClick={() => navigate('/login')}>Log in</a>
              </div>
